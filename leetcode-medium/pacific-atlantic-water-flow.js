...
const pacificAtlantic = (heights) => {
  ...
  const dfs = (r, c, visited, prevHeight) => {
    const rc = r + "," + c;
    // if out of bounds or water can't flow or already visited
    if (
      r < 0 ||
      c < 0 ||
      r >= rowLen ||
...
/*
  ...
  because we know for sure those edge elements can reach its neighboring ocean.
